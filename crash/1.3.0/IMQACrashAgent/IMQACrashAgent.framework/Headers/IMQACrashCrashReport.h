...
@interface IMQACrashCrashReport : NSObject

/**
 *  Create a new crash report from a JSON crash report generated by
 * IMQACrashCrashSentry
 *
 *  @param report a IMQACrashCrashSentry JSON report
 *
 *  @return a IMQACrash crash report
 */
 ...
 *  @param config    IMQACrash configuration
...
initWithErrorName:(NSString *_Nonnull)name
    ...
    configuration:(IMQACrashConfiguration *_Nonnull)config
         metaData:(NSDictionary *_Nonnull)metaData
     handledState:(IMQACrashHandledState *_Nonnull)handledState
          session:(IMQACrashSession *_Nullable)session;
 ...
 *  generates a section on IMQACrash, displaying key/value pairs
 */
@property(readwrite, copy, nonnull) NSDictionary *metaData;
/**
 *  The event state (whether the error is handled/unhandled)
 */
@property(readonly, nonnull) IMQACrashHandledState *handledState;
